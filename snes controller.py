...
def update(dt):
    ...
    #abxy
    ok.append(shapes.Circle(290,20,20,color=AB,batch=batch))
    ok[-1].opacity = opacities[B]
    ok.append(shapes.Circle(330,60,20,color=AB,batch=batch))
    ok[-1].opacity = opacities[A]
    ok.append(shapes.Circle(250,60,20,color=XY,batch=batch))
    ok[-1].opacity = opacities[Y]
    ok.append(shapes.Circle(290,100,20,color=XY,batch=batch))
